...
def pearl_type_model_vgg16(my_training_batch_generator, my_test_batch_generator,
...
def pearl_type_model_resnext101(my_training_batch_generator, my_test_batch_generator,
                                save_dir=os.path.join(os.getcwd(), 'saved_models')
                                , batch_size=32
                                , input_shape=(40, 40, 3)):
    model_name = 'trained_model_resnext101_7_epoch30.h5'
